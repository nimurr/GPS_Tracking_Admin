        ...
        <div className="md:p-4 mt-5 sm:mt-0 text-white">
            ...
            <div className="lg:flex md:flex gap-4 bg-[#1c1c1e] p-10 rounded-xl mt-5">
                <div className="lg:w-1/3 flex flex-col border border-dotted p-4 justify-center items-center gap-8">
                    <img
                        ...
                        src={user?.image ?  user?.image : User_Profile}
                        alt="User Profile"
                    />
                    <div className="flex flex-col justify-center items-center text-center">
                        <p className="text-lg md:text-xl">{user?.role}</p>
                        <h1 className="text-2xl md:text-3xl font-medium">{user?.firstName + user?.lastName}</h1>
                    </div>
                </div>
            ...
            <div className="flex gap-2 items-center md:justify-end justify-center mt-8">
                <div
                    ...
                    className="w-48 !bg-[#fecd38] !text-white py-3 px-6 rounded-lg cursor-pointer flex justify-center items-center gap-2"
                >
                    <FaEdit size={17} />
                    <p>Edit Profile</p>
                </div>
