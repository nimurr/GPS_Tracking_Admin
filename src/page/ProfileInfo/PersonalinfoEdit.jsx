...
const PersonalinfoEdit = () => {
    ...
    return (
        <div className="font-[Aldrich] text-white">
            ...
            <div className="sm:mx-6 rounded-xl bg-[#1c1c1e] p-6 text-white">
                <Form
                    form={form}
                    layout="vertical"
                    autoComplete="off"
                ...
                >
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <PhoneInput
                                        ...
                                        international
                                        defaultCountry="bd"
                                        className="rounded-lg border-gray-300 py-3 text-white focus:ring-blue-500 focus:border-blue-500 border-2 px-2"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex sm:justify-end justify-center items-center mt-8">
                        <Button htmlType="submit" className="h-14 md:px-20 !bg-[#fecd38] !text-white rounded-lg text-lg font-medium">
                            Save Changes
                        </Button>
                    </div>
                </Form>
